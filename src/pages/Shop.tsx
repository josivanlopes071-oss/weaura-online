...
import { ShoppingCart, Star, Zap, Shield, Sparkles, Check, Loader2, Crown, Gem, Gift, Flame } from 'lucide-react';
...
export default function Shop() {
  ...
  const items = [
    { id: 'cyber', name: 'Moldura Cyber Neon', cost: 1500, icon: Sparkles, color: 'text-cyan-400', glow: 'shadow-[0_0_15px_rgba(34,211,238,0.4)]', desc: 'Efeito neon piscante em ciano/magenta' },
    { id: 'golden', name: 'Moldura VIP Imperial', cost: 5000, icon: Crown, color: 'text-amber-400', glow: 'shadow-[0_0_15px_rgba(251,191,36,0.4)]', desc: 'Glow dourado luxuoso com coroa real' },
    { id: 'celestial', name: 'Moldura Galactic Portal', cost: 10050, icon: Star, color: 'text-indigo-400', glow: 'shadow-[0_0_15px_rgba(129,140,248,0.4)]', desc: 'Pulsar de galáxia mística estrelada' },
    { id: 'royal', name: 'Moldura Supreme Pink', cost: 25000, icon: Gift, color: 'text-pink-400', glow: 'shadow-[0_0_15px_rgba(244,114,182,0.4)]', desc: 'Anel rosa pink de extrema realeza e aura' },
    { id: 'demon', name: 'Moldura Devil Overlord', cost: 50000, icon: Flame, color: 'text-red-500', glow: 'shadow-[0_0_15px_rgba(239,68,68,0.4)]', desc: 'Onyx negro abrasador com labaredas de fogo' },
    { id: 'prism', name: 'Moldura Pris-Aura Portal', cost: 100000, icon: Gem, color: 'text-emerald-400', glow: 'shadow-[0_0_15px_rgba(52,211,153,0.4)]', desc: 'Escudo prismático místico com transição infinita' }
  ];
