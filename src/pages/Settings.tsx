...
import { ChevronRight, Shield, Bell, Moon, Languages, HelpCircle, Lock, Smartphone, LogOut, ChevronLeft } from 'lucide-react';
            ...
            <div className="glass-dark rounded-[40px] border border-white/[0.08] overflow-hidden shadow-premium">
               {section.items.map((item, itemIdx) => (
                 <div key={itemIdx} className="card-shine">
                   <div className="p-6 flex items-center justify-between hover:bg-white/[0.04] transition-all cursor-pointer group active:bg-white/[0.06]">
                      ...
                      {item.isSwitch ? (
                        ...
                        <div className="flex items-center gap-4">
                           {item.value && <span className="text-[12px] font-black text-white/30 italic">{item.value}</span>}
